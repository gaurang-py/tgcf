...
<p align="center">
<a href = "https://github.com/gaurang-py/tgcf" > <img src = "https://user-images.githubusercontent.com/66209958/115183360-3fa4d500-a0f9-11eb-9c0f-c5ed03a9ae17.png" alt = "tgcf logo"  width=120> </a>
</p>
...
<p align="center">
<a href="https://github.com/gaurang-py/tgcf/blob/main/LICENSE"><img src="https://img.shields.io/github/license/aahnik/tgcf" alt="GitHub license"></a>
<a href="https://github.com/gaurang-py/tgcf/stargazers"><img src="https://img.shields.io/github/stars/aahnik/tgcf?style=social" alt="GitHub stars"></a>
<a href="https://github.com/gaurang-py/tgcf/issues"><img src="https://img.shields.io/github/issues/aahnik/tgcf" alt="GitHub issues"></a>
...
<p align="center">
<a href="https://github.com/gaurang-py/tgcf/actions/workflows/quality.yml"><img src="https://github.com/gaurang-py/tgcf/actions/workflows/quality.yml/badge.svg" alt="Code Quality"></a>
</p>
<!-- markdownlint-enable -->
...
2. Supports two [modes](https://github.com/gaurang-py/tgcf/wiki/Past-vs-Live-modes-explained)
of operation _past_ or _live_.

    > The past mode deals with all existing messages,
    > while the live mode is for upcoming ones.

3. You may [login](https://github.com/gaurang-py/tgcf/wiki/Login-with-a-bot-or-user-account)
...
4. Perform custom manipulation on messages.
    ...
    > You can
    [filter](https://github.com/gaurang-py/tgcf/wiki/How-to-use-filters-%3F),
    [format](https://github.com/gaurang-py/tgcf/wiki/Format-text-before-sending-to-destination),
    [replace](https://github.com/gaurang-py/tgcf/wiki/Text-Replacement-feature-explained),
    [watermark](https://github.com/gaurang-py/tgcf/wiki/How-to-use--watermarking-%3F),
    [ocr](https://github.com/gaurang-py/tgcf/wiki/You-can-do-OCR)
    and do whatever else you need !

5. Detailed [wiki](https://github.com/gaurang-py/tgcf/wiki) +
Video tutorial.
    > You can also [get help](#getting-help) from the community.

6. If you are a python developer, writing
[plugins](https://github.com/gaurang-py/tgcf/wiki/How-to-write-a-plugin-for-tgcf-%3F)
...
[Windows guide](https://github.com/gaurang-py/tgcf/wiki/Run-tgcf-on-Windows)
is for you.
...
Read the
[guide for android](https://github.com/gaurang-py/tgcf/wiki/Run-on-Android-using-Termux)
to learn.

- If you are familiar with **Docker**, you may read the
[docker guide](https://github.com/gaurang-py/tgcf/wiki/Install-and-run-using-docker)
...
- [`.env`](https://github.com/gaurang-py/tgcf/wiki/Environment-Variables)
: To define your environment variables easily.

- [`tgcf.config.yml`](https://github.com/gaurang-py/tgcf/wiki/How-to-configure-tgcf-%3F)
...
For more details run `tgcf --help` or [read wiki](https://github.com/gaurang-py/tgcf/wiki/CLI-Usage).
...
- [Heroku](https://github.com/gaurang-py/tgcf/wiki/Deploy-to-Heroku)
- [Digital Ocean](https://github.com/gaurang-py/tgcf/wiki/Deploy-to-Digital-Ocean)
- [Gitpod](https://github.com/gaurang-py/tgcf/wiki/Run-for-free-on-Gitpod")
- [Python Anywhere](https://github.com/gaurang-py/tgcf/wiki/Run-on-PythonAnywhere)
- [Google Cloud Run](https://github.com/gaurang-py/tgcf/wiki/Run-on-Google-Cloud)
- [GitHub Actions](https://github.com/gaurang-py/tgcf/wiki/Run-tgcf-in-past-mode-periodically)
